...
class fields:
    wb = load_workbook('/Users/oulongwen/Google Drive/self share/fcml.xlsx',data_only=True, read_only = True)
    ws = wb['2015 FCML']
    ...
    wb2 = load_workbook('/Users/oulongwen/Google Drive/self share/oil and gas fields.xlsx',data_only=True, read_only = True)
    ws2 = wb2['Oil fields']
    ws3 = wb2['Gas fields']
